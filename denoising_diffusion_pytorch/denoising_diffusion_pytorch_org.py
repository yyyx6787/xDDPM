...
#        assert not (type(self) == GaussianDiffusion and model.channels != model.out_dim)
    ...
    def p_losses(self, x_start, t, area, noise = None, offset_noise_strength = None):
        ...
        x, _ = self.q_sample(x_start = x_start, t = t, noise = noise)
...
class Trainer(object):
    def __init__(
        ...
        *,
        ...
        # self.load_pretrain('/zhangqianru/code/results_ddpm_org/model-34.pt')  # model-40 performance最好 , model-34效果最好
    ...
    #     #   print("&&:", name)
    #     # pritnln()
    #     self.model.load_state_dict(weight, False)  # adding false is very important for debug
            ...
            while self.step < self.train_num_steps:
                ...
                if accelerator.is_main_process:
                    ...
                    if self.step != 0 and divisible_by(self.step, self.save_and_sample_every):
                        ...
                        # file.close()
                        print("saving sampled images done")
